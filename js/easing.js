jQuery.extend(jQuery.easing, {
    ...
    easeInOutCirc: function(e, a, c, b, d) {
        return 1 >
            (a /= d / 2) ? -b / 2 * (Math.sqrt(1 - a * a) - 1) + c : b / 2 * (Math.sqrt(1 - (a -= 2) * a) + 1) + c
    },
    ...
    easeOutElastic: function(e, a, c, b, d) {
        ...
        return g * Math.pow(2, -10 * a) * Math.sin(2 * (a * d - e) * Math.PI / f) +
            b + c
    },
    ...
    easeInOutBounce: function(e, a, c, b, d) {
        return a < d / 2 ? .5 * jQuery.easing.easeInBounce(e, 2 * a, 0, b, d) + c :
            .5 * jQuery.easing.easeOutBounce(e, 2 * a - d, 0, b, d) + .5 * b + c
    }
});