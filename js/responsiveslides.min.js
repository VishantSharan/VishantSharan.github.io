(function(c, K, C) {
    c.fn.responsiveSlides = function(m) {
        ...
        return this.each(function() {
            ...
            var f = c(this),
                ...
                G = function() {
                    ...
                    for (c = 0; c < t.length; c++)
                        if ("string" === typeof b[t[c] + a]) return !0;
                    return !1
                }(),
                A = function(b) {
                    a.before(b);
                    G ? (e.removeClass(k).css(z).eq(b).addClass(k).css(y),
                        n = b, setTimeout(function() {
                            a.after(b)
                        }, h)) : e.stop().fadeOut(h, function() {
                        c(this).removeClass(k).css(z).css("opacity", 1)
                    }).eq(b).fadeIn(h, function() {
                        c(this).addClass(k).css(y);
                        a.after(b);
                        n = b
                    })
                };
            ...
            f.addClass(g + " " + d);
            m && m.maxwidth && f.css("max-width", v);
            e.hide().css(z).eq(0).addClass(k).css(y).show();
            G && e.show().css({
            ...
            if (1 < e.size()) {
                ...
                (a.pager || a.manualControls) && l.find("li").each(function(a) {
                    c(this).addClass(x + (a + 1))
                });
                if (a.pager || a.manualControls) {
                    var r =
                        l.find("a");
                    var B = function(a) {
                        r.closest("li").removeClass(w).eq(a).addClass(w)
                    }
                }
                a.auto && (u = function() {
                    p = setInterval(function() {
                        e.stop(!0, !0);
                        var b = n + 1 < D ? n + 1 : 0;
                        (a.pager || a.manualControls) && B(b);
                        A(b)
                    }, E)
                }, u());
                var q = function() {
                    a.auto && (clearInterval(p), u())
                };
                ...
                if (a.pager || a.manualControls) r.bind("click", function(b) {
                        ...
                        a.pauseControls || q();
                        b = r.index(this);
                        n === b || c("." + k).queue("fx").length || (B(b), A(b))
                    }).eq(0).closest("li").addClass(w),
                ...
                if (a.nav) {
                    ...
                    d.bind("click", function(b) {
                        ...
                        if (!b.queue("fx").length) {
                            ...
                            d = d + 1 < D ? n + 1 : 0;
                            A(c(this)[0] === I[0] ? b : d);
                            (a.pager || a.manualControls) && B(c(this)[0] === I[0] ? b : d);
                            a.pauseControls || q()
                        }
                    });
